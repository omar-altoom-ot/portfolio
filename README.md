...
The goal of this project is to practice **HTML, CSS, and layout design**, and to turn a Figma design into a real working website.
...
```bash
git clone https://github.com/omar-altoom-ot/protfolio.git
cd protfolio
```
...
* GitHub: https://github.com/omar-altoom-ot
